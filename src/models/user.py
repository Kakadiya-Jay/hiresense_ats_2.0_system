...
class User(Base):
    ...
    email = Column(VARCHAR(65), unique=True, nullable=False)
    ...
    recruiter_role = Column(VARCHAR(25), nullable=True)
    business_name = Column(VARCHAR(50), nullable=True)
    website_url = Column(VARCHAR(255), nullable=True)
    linkedin_url = Column(VARCHAR(255), nullable=True)
